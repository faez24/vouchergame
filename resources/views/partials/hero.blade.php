    ...
    <div class="mt-6 md:-mt-20 relative z-20 w-full max-w-[1440px] mx-auto px-3 sm:px-4 lg:px-6">
        ...
        <div class="relative w-full group/slider overflow-visible">
            ...
            <div class="flex-shrink-0 snap-center w-[155px] sm:w-[175px] md:w-[195px] cursor-pointer">
                <div class="bg-[#1c2030] border border-white/10 rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.6)] hover:shadow-[0_0_30px_rgba(34,197,94,0.25)] hover:border-green-500/40 transition-all duration-300 hover:-translate-y-1 h-full" >
            ...
            <div class="flex-shrink-0 snap-center w-[155px] sm:w-[175px] md:w-[195px] cursor-pointer" onclick="openFlashSaleModal()">
                <div class="bg-[#1c2030] border border-white/10 rounded-2xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.6)] hover:shadow-[0_0_30px_rgba(249,115,22,0.25)] hover:border-orange-500/40 transition-all duration-300 hover:-translate-y-1 h-full" >
                    <div class="h-28 sm:h-32 bg-[#1a1f2e] relative overflow-hidden">
        ...
        <div class="flex justify-center gap-2 mt-1">
            <span class="w-2.5 h-2.5 rounded-full bg-green-400 shadow-[0_0_8px_rgba(34,197,94,0.8)]"></span>
