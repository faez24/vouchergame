...
<div class="mb-6 w-full">
    ...
    <div class="mt-6 md:-mt-36 relative z-20 w-full max-w-[1440px] mx-auto px-3 sm:px-4 lg:px-6">
        ...
        {{-- cards --}}
        <div class="flex gap-3 md:gap-5 overflow-x-auto lg:justify-center px-1 pb-3 scrollbar-hide snap-x snap-mandatory"
             style="-ms-overflow-style:none;scrollbar-width:none;">

            {{-- Card 1: Valorant VP --}}
            <div class="flex-shrink-0 snap-center w-[140px] sm:w-[160px] md:w-[180px] group cursor-pointer">
                <div class="bg-[#0a101d]/90 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden hover:border-cyan-500/50 hover:shadow-[0_0_25px_rgba(34,211,238,0.2)] transition-all h-full">
                    <div class="h-28 sm:h-32 bg-[#1a1f2e] relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1542751371-adc38448a05e?w=400&h=400&fit=crop" class="w-full h-full object-cover opacity-60 group-hover:scale-110 group-hover:opacity-100 transition-all duration-500" />
            ...
            <div class="flex-shrink-0 snap-center w-[140px] sm:w-[160px] md:w-[180px] group cursor-pointer">
                <div class="bg-[#0a101d]/90 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden hover:border-pink-500/50 hover:shadow-[0_0_25px_rgba(236,72,153,0.2)] transition-all h-full">
                    <div class="h-28 sm:h-32 bg-[#1a1f2e] relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1556438064-2d7646166914?w=400&h=400&fit=crop" class="w-full h-full object-cover opacity-60 group-hover:scale-110 group-hover:opacity-100 transition-all duration-500" />
            ...
            <div class="flex-shrink-0 snap-center w-[140px] sm:w-[160px] md:w-[180px] group cursor-pointer">
                <div class="bg-[#0a101d]/90 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden hover:border-cyan-500/50 hover:shadow-[0_0_25px_rgba(34,211,238,0.2)] transition-all h-full">
                    <div class="h-28 sm:h-32 bg-[#1a1f2e] relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1560253023-3ec5d502959f?w=400&h=400&fit=crop" class="w-full h-full object-cover opacity-60 group-hover:scale-110 group-hover:opacity-100 transition-all duration-500" />
            ...
            <div class="flex-shrink-0 snap-center w-[140px] sm:w-[160px] md:w-[180px] group cursor-pointer">
                <div class="bg-[#0a101d]/90 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden hover:border-pink-500/50 hover:shadow-[0_0_25px_rgba(236,72,153,0.2)] transition-all h-full">
                    <div class="h-28 sm:h-32 bg-[#1a1f2e] relative overflow-hidden">
                        <img src="https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=400&h=400&fit=crop" class="w-full h-full object-cover opacity-60 group-hover:scale-110 group-hover:opacity-100 transition-all duration-500" />
