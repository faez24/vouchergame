<footer id="footer" class="mt-16 border-t border-white/5 relative w-full bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('images/footer.png') }}');">
    ...
    <div class="absolute bottom-0 left-0 w-80 h-80 bg-green-500/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/4 pointer-events-none"></div>
    ...
    <div class="max-w-[1440px] mx-auto w-full px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 pb-6">
        ...
        <div class="col-span-2 md:col-span-3 lg:col-span-2">
            <a href="/" class="flex items-center gap-3 w-fit mb-6">
                <span class="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-green-400 to-green-700 text-sm font-extrabold tracking-tight text-white shadow-[0_0_15px_rgba(34,197,94,0.5)]">GV</span>
            ...
            <div class="flex gap-3">
                <a href="#" aria-label="Facebook" class="w-10 h-10 rounded-xl bg-white/[0.03] hover:bg-green-500/10 hover:text-green-400 border border-white/5 hover:border-green-500/30 flex items-center justify-center transition-all duration-300 text-gray-400 hover:shadow-[0_0_10px_rgba(34,197,94,0.2)]">
                ...
                <a href="#" aria-label="Instagram" class="w-10 h-10 rounded-xl bg-white/[0.03] hover:bg-orange-500/10 hover:text-orange-400 border border-white/5 hover:border-orange-500/30 flex items-center justify-center transition-all duration-300 text-gray-400 hover:shadow-[0_0_10px_rgba(249,115,22,0.2)]">
                ...
                <a href="#" aria-label="Twitter" class="w-10 h-10 rounded-xl bg-white/[0.03] hover:bg-green-500/10 hover:text-green-400 border border-white/5 hover:border-green-500/30 flex items-center justify-center transition-all duration-300 text-gray-400 hover:shadow-[0_0_10px_rgba(34,197,94,0.2)]">
                ...
                <a href="#" aria-label="YouTube" class="w-10 h-10 rounded-xl bg-white/[0.03] hover:bg-orange-500/10 hover:text-orange-400 border border-white/5 hover:border-orange-500/30 flex items-center justify-center transition-all duration-300 text-gray-400 hover:shadow-[0_0_10px_rgba(249,115,22,0.2)]">
        ...
        <div class="col-span-1">
            ...
            <ul class="space-y-4">
                <li><a href="#" class="text-gray-400 hover:text-white transition-colors text-sm font-medium flex items-center gap-2"><span class="w-1.5 h-1.5 rounded-full bg-green-500/50 shadow-[0_0_5px_rgba(34,197,94,0.8)]"></span>Mobile Legends</a></li>
                <li><a href="#" class="text-gray-400 hover:text-white transition-colors text-sm font-medium flex items-center gap-2"><span class="w-1.5 h-1.5 rounded-full bg-orange-500/50 shadow-[0_0_5px_rgba(249,115,22,0.8)]"></span>Free Fire</a></li>
                <li><a href="#" class="text-gray-400 hover:text-white transition-colors text-sm font-medium flex items-center gap-2"><span class="w-1.5 h-1.5 rounded-full bg-green-600/50 shadow-[0_0_5px_rgba(59,130,246,0.8)]"></span>PUBG Mobile</a></li>
    ...
    <div class="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 relative z-10">
        <p class="text-gray-500 text-sm font-medium">© 2026 WarGame. All rights reserved.</p>
